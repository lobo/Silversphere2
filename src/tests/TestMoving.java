...
public class TestMoving {
	@Test
	public void MovePlayerNORTHtoEmptyFloor() throws InvalidBoardSizeException, PositionOutOfBoundsException{
	...
	public void MovePlayerToSamePositionBefore() throws InvalidBoardSizeException, PositionOutOfBoundsException{
	...
	@Test
	public void MoveToWaterandIceBeRemoved() throws InvalidBoardSizeException, PositionOutOfBoundsException{
		
		Board board= new Board(10,10);
		Player player= new Player(new Point(5,5), board);
		board.putContent(player, player.getPosition());
		board.setPlayer(player);
		Point nextPosition= board.SetPositionCardinal(player.getPosition(), Cardinal.SOUTH);
		
		Ice ice = new Ice(nextPosition, board);
		board.putContent(ice, nextPosition);
		board.putCell(new Water(),board.SetPositionCardinal(nextPosition, Cardinal.SOUTH));
...
//		assertTrue(((ContentOperations)(board.getTile(nextPosition))).getContent()==null);
	...
	@Test
	public void MoveIcetoWaterRemoveItandMovePlayerToo() throws InvalidBoardSizeException, PositionOutOfBoundsException{
	...
	@Test
	public void NotAbletoMovePlayerSOUTHToTree() throws InvalidBoardSizeException, PositionOutOfBoundsException{
	...
	public void MovePlayerToTileWithMovingBox() throws InvalidBoardSizeException, PositionOutOfBoundsException{
		...
		board.putContent(player, player.getPosition());
		board.setPlayer(player);
		Point nextPosition= board.SetPositionCardinal(player.getPosition(), Cardinal.EAST);
